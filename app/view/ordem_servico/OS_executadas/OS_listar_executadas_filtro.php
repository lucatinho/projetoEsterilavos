...
<body>
    ...
    <script type="text/javascript">
        function pegarValores() {
            ...
            // alert(texto);
            // alert($ano + $mes);
            window.location.href = "OS_listar_executadas.php?cliente=<?php echo $idcliente; ?>&setor=<?php echo $idsetor; ?>&equipamento=<?php echo $idequipamento; ?>&ano=" + $ano + "&mes=" + $mes + "&tipo=" + $tipo;
        }
    </script>
</body>
