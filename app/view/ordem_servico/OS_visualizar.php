            ...
            <div class="col-md-10 order-md-1">
                ...
                <form class="needs-validation" novalidate method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="lastName">Ano de Fabricação</label>
                            <input type="text" name="AnoFabrica" class="form-control" value="<?php echo $row['AnoFabrica'] ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="OS_executadas/OS_listar_executadas_filtro.php?cliente=<?php echo $idcliente; ?>&setor=<?php echo $idsetor; ?>&equipamento=<?php echo $idequipamento; ?>" style="float:left;" class="btn btn-info">Voltar</a>
                    </div> 
