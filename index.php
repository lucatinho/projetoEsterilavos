...
<div class="row" style="margin-top: 10px;">
	<div class="col-md-10 col-md-offset-1" >
		<table class="table">
	 <a style="float:left;" class="btn btn-info" href="cadastrar.php" > Cadastrar Cliente</a>
...
<td><input type="checkbox" value ="<?php echo $row['id_Cliente'] ?>" class="marcar" name="idsClientes[]"></td>
    ...
    <div class="mt-5 pt-2 pb-1 "style="
  background: #1b1b1b;
  color:#212529;
position:relative;
bottom:0px;
...
width:100%;};">
    <div class="about-company">
      <p style="text-align:center; font-size:12px;" class="text-white-20">ESTERILAV COM. E MANUT. DE EQUIP. HOSP. LTDA-EPP | CNPJ nº
            52.119.963/0001-02 </p>
             <p style="text-align:center; font-size:12px;" class="text-white-20"><small >Copyright © Esterilav. (Lei 9610 de 19/02/1998)</small></p>
    </div>
        </div>
