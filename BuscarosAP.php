...
if(isset($_POST['search'])){
		...
		$sql = "select * from os where Status ='Aprovado'  and id_OsCliente ='$id'  and idOS like '%$name%'";
		$rows = $dbd->query($sql);
...
<head>
    ...
    <title>Buscar OS Aprovados</title>
...
<div class="container">
<center><h1>Buscar OS Aprovados</h1></center>
<div class="row" style="margin-top: 10px;">
	<div class="col-md-10 col-md-offset-1" >
		...
		<div class="col-md-12 text-center">
			<form action="BuscarosAP.php" method="post" class="form-group">
...
Nada encontrado</h2>
		   ...
		   <a href="ListarAnalisados.php" style="float:left;" class="btn btn-info">Voltar</a>
